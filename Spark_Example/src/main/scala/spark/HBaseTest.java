...
public class HBaseTest {
    ...
    public static void main(String[] args) {
        ...
        SparkConf conf1 = new SparkConf().setAppName(
                ...
                "local").set("spark.serializer", "org.apache.spark.serializer.KryoSerializer")
                .setJars(new String[]{"C:\\Git\\Demos\\Examples\\Spark_Example\\target\\Spark_Example-1.0-SNAPSHOT.jar"});
        ...
        try {
            ...
            JavaPairRDD<ImmutableBytesWritable, Result> hBaseRDD = sc.newAPIHadoopRDD(conf,
                    ...
                    Result.class);
            System.out.println(hBaseRDD.collect());
